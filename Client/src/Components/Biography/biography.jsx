...
function Biography() {
    const [profil, setProfil] = useState({
        biography: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi, sunt sed? Eius est obcaecati animi fugit iure incidunt fugiat eum natus corporis ex. Voluptatibus qui itaque sequi hic obcaecati iusto.,"
      });
    ...
    return ( 
        <div className="biography-contenant">
        <div className="biography-contenant-title">
          Ma minibio
          <button className="edit-icon" onClick={() => handleEdit("biography")}>
        ...
        <div className="biography-contenant-texte">
          {editingField === "biography" ? (
            <textarea
              name="biography"
              value={profil.biography}
